...
import { idlFactory } from './private_chats.did.js';
export { idlFactory } from './private_chats.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PRIVATE_CHATS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./private_chats.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the private_chats canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./private_chats.did.js")._SERVICE>}
 */
export const private_chats = createActor(canisterId);
