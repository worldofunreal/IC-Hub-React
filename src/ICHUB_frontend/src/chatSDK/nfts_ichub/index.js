...
import { idlFactory } from './nfts_ichub.did.js';
export { idlFactory } from './nfts_ichub.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NFTS_ICHUB_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./nfts_ichub.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the nfts_ichub canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./nfts_ichub.did.js")._SERVICE>}
 */
export const nfts_ichub = createActor(canisterId);
