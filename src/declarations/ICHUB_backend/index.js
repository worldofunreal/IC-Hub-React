...
import { idlFactory } from './ICHUB_backend.did.js';
export { idlFactory } from './ICHUB_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICHUB_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ICHUB_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ICHUB_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ICHUB_backend.did.js")._SERVICE>}
 */
export const ICHUB_backend = createActor(canisterId);
