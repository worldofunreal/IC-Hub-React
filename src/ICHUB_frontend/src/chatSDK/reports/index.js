...
import { idlFactory } from './reports.did.js';
export { idlFactory } from './reports.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.REPORTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./reports.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the reports canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./reports.did.js")._SERVICE>}
 */
export const reports = createActor(canisterId);
