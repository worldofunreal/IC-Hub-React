...
import { idlFactory } from './nfts_standards.did.js';
export { idlFactory } from './nfts_standards.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NFTS_STANDARDS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./nfts_standards.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the nfts_standards canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./nfts_standards.did.js")._SERVICE>}
 */
export const nfts_standards = createActor(canisterId);
