...
import { idlFactory } from './public_group.did.js';
export { idlFactory } from './public_group.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PUBLIC_GROUP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./public_group.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the public_group canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./public_group.did.js")._SERVICE>}
 */
export const public_group = createActor(canisterId);
