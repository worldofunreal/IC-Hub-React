...
export const canisterId = process.env.CORE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./core.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the core canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./core.did.js")._SERVICE>}
 */
export const core = createActor(canisterId);
