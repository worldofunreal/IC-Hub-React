...
import { idlFactory } from './ICHUB_frontend.did.js';
export { idlFactory } from './ICHUB_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICHUB_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ICHUB_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ICHUB_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ICHUB_frontend.did.js")._SERVICE>}
 */
export const ICHUB_frontend = createActor(canisterId);
