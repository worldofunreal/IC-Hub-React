...
import { idlFactory } from './projects.did.js';
export { idlFactory } from './projects.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PROJECTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./projects.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the projects canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./projects.did.js")._SERVICE>}
 */
export const projects = createActor(canisterId);
